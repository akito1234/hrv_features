...
path = r"Z:\00_個人用\東間\01.theme\柴田_依頼\toma1000Hz_1.csv"
## Read OpenSignals file and plot all signals
#arc = OpenSignalsReader(path)

rppg = np.loadtxt(path,delimiter=",")
# peak detection
#signal, rpeaks= signals.ecg.ecg(signal= arc.signal("ECG"), sampling_rate=1000.0, show=True)[1:3]

signal, rpeaks= signals.ecg.ecg(signal= rppg, sampling_rate=1000.0, show=True)[1:3]
